    ...
    public void game()
    {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.get().load(quizQuestion).into(question);
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(Quiz_Page.this, "There is a problem."
                        , Toast.LENGTH_SHORT).show();
        ...
        databaseReferenceSecond.child("scores").child(userUID).child("correct").setValue(userCorrect)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Quiz_Page.this, "Scores sent successfully", Toast.LENGTH_SHORT).show();
